...
define('dummy/tests/integration/components/swiper-container-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('swiper-container', 'Integration | Component | swiper container', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'swiper-container', ['loc', [null, [1, 0], [1, 20]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'swiper-container', [], [], 0, null, ['loc', [null, [2, 4], [4, 25]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('dummy/tests/integration/components/swiper-container-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/swiper-container-test.js should pass jscs', function () {
    ok(true, 'integration/components/swiper-container-test.js should pass jscs.');
  });
});
define('dummy/tests/integration/components/swiper-container-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components/swiper-container-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/swiper-container-test.js should pass jshint.');
  });
});
define('dummy/tests/integration/components/swiper-slide-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('swiper-slide', 'Integration | Component | swiper slide', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'swiper-slide', ['loc', [null, [1, 0], [1, 16]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'swiper-slide', [], [], 0, null, ['loc', [null, [2, 4], [4, 21]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('dummy/tests/integration/components/swiper-slide-test.jscs-test', ['exports'], function (exports) {
  ...
  module('JSCS - integration/components');
  test('integration/components/swiper-slide-test.js should pass jscs', function () {
    ok(true, 'integration/components/swiper-slide-test.js should pass jscs.');
  });
});
define('dummy/tests/integration/components/swiper-slide-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components/swiper-slide-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/swiper-slide-test.js should pass jshint.');
  });
});
